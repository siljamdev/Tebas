...
static class Palette{
	...
	public static CharFormat? hint = new CharFormat(new Color3("#C19C00"));
	...
	public static void init(){
		useColors = !Tebas.noColors && Tebas.config.GetValue<bool>("useColors") && !Console.IsOutputRedirected;
	}
}